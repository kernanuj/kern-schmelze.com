...
class DeliveryNoteGeneratorDecorated implements DocumentGeneratorInterface
{
    ...
    const DOCUMENT_NAME = 'WeloAddressDocument6DeliveryNote';

    /**
     * InvoiceGeneratorDecorated constructor.
     *
     * @param DocumentGeneratorInterface $deliveryNoteGenerator
    ...
    public function generate(
        ...
        $config->assign(['weloIsDeliveryActive' => (bool)$this->configuration->getPluginConfig(self::DOCUMENT_NAME)]);
