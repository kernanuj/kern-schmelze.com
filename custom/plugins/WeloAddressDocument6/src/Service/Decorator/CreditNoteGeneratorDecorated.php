...
class CreditNoteGeneratorDecorated implements DocumentGeneratorInterface
{
    ...
    const DOCUMENT_NAME = 'WeloAddressDocument6Credit';

    /**
     * InvoiceGeneratorDecorated constructor.
     *
     * @param DocumentGeneratorInterface $creditNoteGenerator
    ...
    public function generate(
        ...
        $config->assign(['weloIsCreditActive' => (bool)$this->configuration->getPluginConfig(self::DOCUMENT_NAME)]);
