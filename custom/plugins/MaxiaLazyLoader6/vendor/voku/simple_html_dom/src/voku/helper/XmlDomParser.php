 ...
 */
class XmlDomParser extends \_PhpScoperfd240ab1f7e6\voku\helper\AbstractDomParser
{
    /**
    ...
    public function __construct($element = null)
    {
        ...
        if ($element instanceof \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface) {
    ...
    public function find(string $selector, $idx = null)
    {
        ...
        if ($nodesList) {
            foreach ($nodesList as $node) {
                $elements[] = new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDom($node);
            }
        }
        // return all elements
        if ($idx === null) {
    ...
    {
        $return = $this->find($selector, null);
        if ($return instanceof \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomNodeBlank) {
            return \false;
        }
        return $return;
    }
    ...
    {
        $return = $this->find($selector, 0);
        if ($return instanceof \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomBlank) {
            return \false;
        }
        return $return;
    }
    ...
    public function getElementByTagName(string $name) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
        ...
        return new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDom($node);
    }
    /**
    ...
    public function getElementsByTagName(string $name, $idx = null)
    {
        ...
        // return one element
        return $elements[$idx] ?? new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomNodeBlank();
    }
    /**
    ...
    public function loadXmlFile(string $filePath, $libXMLExtraOptions = null) : self
    {
        ...
        try {
            if (\class_exists('_PhpScoperfd240ab1f7e6\\voku\\helper\\UTF8')) {
                /** @noinspection PhpUndefinedClassInspection */
                $xml = \_PhpScoperfd240ab1f7e6\voku\helper\UTF8::file_get_contents($filePath);
            } else {
