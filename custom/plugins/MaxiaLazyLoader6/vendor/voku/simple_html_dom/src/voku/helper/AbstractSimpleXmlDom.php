...
abstract class AbstractSimpleXmlDom
{
    ...
    public abstract function innerXml(bool $multiDecodeNewHtmlEntity = \false) : string;
    public abstract function removeAttribute(string $name) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface;
    protected abstract function replaceChildWithString(string $string) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface;
    protected abstract function replaceNodeWithString(string $string) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface;
    /**
     * @param string $string
     *
     * @return SimpleXmlDomInterface
     */
    protected abstract function replaceTextWithString($string) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface;
    /**
     * @param string $name
     ...
     * @return SimpleXmlDomInterface
     */
    public abstract function setAttribute(string $name, $value = null, bool $strict = \false) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface;
    public abstract function text() : string;
    public abstract function xml(bool $multiDecodeNewHtmlEntity = \false) : string;
}
