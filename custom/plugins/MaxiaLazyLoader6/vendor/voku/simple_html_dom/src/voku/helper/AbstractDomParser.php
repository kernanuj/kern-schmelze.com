...
abstract class AbstractDomParser implements \_PhpScoperfd240ab1f7e6\voku\helper\DomParserInterface
{
    /**
     * @var string
     */
     ...
     * @return \DOMDocument
     */
    protected abstract function createDOMDocument(string $html, $libXMLExtraOptions = null) : \DOMDocument;
    /**
    ...
    protected function decodeHtmlEntity(string $content, bool $multiDecodeNewHtmlEntity) : string
    {
        if ($multiDecodeNewHtmlEntity) {
            if (\class_exists('_PhpScoperfd240ab1f7e6\\voku\\helper\\UTF8')) {
                ...
                $content = \_PhpScoperfd240ab1f7e6\voku\helper\UTF8::rawurldecode($content, \true);
            } else {
                do {
            ...
            if (\class_exists('_PhpScoperfd240ab1f7e6\\voku\\helper\\UTF8')) {
                /** @noinspection PhpUndefinedClassInspection */
                $content = \_PhpScoperfd240ab1f7e6\voku\helper\UTF8::rawurldecode($content, \false);
            } else {
                $content = \rawurldecode(\html_entity_decode($content, \ENT_QUOTES | \ENT_HTML5));
            }
        }
     ...
     * @param string $selector
     */
    public abstract function findMulti(string $selector);
    /**
     * Find nodes with a CSS selector or false, if no element is found.
     *
     * @param string $selector
     */
    public abstract function findMultiOrFalse(string $selector);
    /**
     * Find one node with a CSS selector.
     *
     * @param string $selector
     */
    public abstract function findOne(string $selector);
    /**
     * Find one node with a CSS selector or false, if no element is found.
     *
     * @param string $selector
     */
    public abstract function findOneOrFalse(string $selector);
    /**
     * @return \DOMDocument
     */
     ...
     */
    public abstract function loadHtml(string $html, $libXMLExtraOptions = null) : \_PhpScoperfd240ab1f7e6\voku\helper\DomParserInterface;
    /**
     * Load HTML from file.
     *
     ...
     * @return DomParserInterface
     */
    public abstract function loadHtmlFile(string $filePath, $libXMLExtraOptions = null) : \_PhpScoperfd240ab1f7e6\voku\helper\DomParserInterface;
    /**
    ...
    public static function putReplacedBackToPreserveHtmlEntities(string $html) : string
    {
        ...
        if (isset(self::$domBrokenReplaceHelper['tmp']) && \count(self::$domBrokenReplaceHelper['tmp']) > 0) {
