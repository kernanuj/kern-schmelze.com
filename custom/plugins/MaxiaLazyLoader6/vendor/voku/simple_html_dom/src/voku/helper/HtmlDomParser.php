 ...
 *                                 <p>Load HTML from string.</p>
 */
class HtmlDomParser extends \_PhpScoperfd240ab1f7e6\voku\helper\AbstractDomParser
{
    /**
     * @var string[]
     */
    ...
    public function __construct($element = null)
    {
        ...
        if ($element instanceof \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface) {
    ...
    protected function createDOMDocument(string $html, $libXMLExtraOptions = null) : \DOMDocument
    {
        ...
        if ($this->isDOMDocumentCreatedWithoutWrapper || $this->isDOMDocumentCreatedWithCommentWrapper || !$isDOMDocumentCreatedWithDoctype && $this->keepBrokenHtml) {
        ...
        if ($sxe !== \false && \count(\libxml_get_errors()) === 0) {
            ...
            if ($domElementTmp && $domElementTmp->ownerDocument) {
                $documentFound = \true;
    ...
    {
        $xPathQuery = \_PhpScoperfd240ab1f7e6\voku\helper\SelectorConverter::toXPath($selector);
        $xPath = new \DOMXPath($this->document);
        $nodesList = $xPath->query($xPathQuery);
        $elements = new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomNode();
        if ($nodesList) {
            foreach ($nodesList as $node) {
                $elements[] = new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDom($node);
            }
        }
        // return all elements
        if ($idx === null) {
    ...
    {
        $return = $this->find($selector, 0);
        if ($return instanceof \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomBlank) {
            return \false;
        }
        return $return;
    }
    ...
    public function getElementByTagName(string $name) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
        ...
        return new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDom($node);
    }
    /**
    ...
    public function getElementsByTagName(string $name, $idx = null)
    {
        ...
        // return one element
        return $elements[$idx] ?? new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomNodeBlank();
    }
    /**
     ...
     * @return HtmlDomParser
     */
    public function loadHtml(string $html, $libXMLExtraOptions = null) : \_PhpScoperfd240ab1f7e6\voku\helper\DomParserInterface
    {
        // reset
     ...
     * @return HtmlDomParser
     */
    public function loadHtmlFile(string $filePath, $libXMLExtraOptions = null) : \_PhpScoperfd240ab1f7e6\voku\helper\DomParserInterface
    {
        // reset
        self::$domBrokenReplaceHelper = [];
        ...
        try {
            if (\class_exists('_PhpScoperfd240ab1f7e6\\voku\\helper\\UTF8')) {
                /** @noinspection PhpUndefinedClassInspection */
                $html = \_PhpScoperfd240ab1f7e6\voku\helper\UTF8::file_get_contents($filePath);
            } else {
     ...
     * @return HtmlDomParser
     */
    public function useKeepBrokenHtml(bool $keepBrokenHtml) : \_PhpScoperfd240ab1f7e6\voku\helper\DomParserInterface
    {
     ...
     * @return HtmlDomParser
     */
    public function overwriteTemplateLogicSyntaxInSpecialScriptTags(array $templateLogicSyntaxInSpecialScriptTags) : \_PhpScoperfd240ab1f7e6\voku\helper\DomParserInterface
    {
     ...
     * @return HtmlDomParser
     */
    public function overwriteSpecialScriptTags(array $specialScriptTags) : \_PhpScoperfd240ab1f7e6\voku\helper\DomParserInterface
    {
