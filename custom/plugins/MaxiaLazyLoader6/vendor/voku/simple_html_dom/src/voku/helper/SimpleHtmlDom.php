 ...
 */
class SimpleHtmlDom extends \_PhpScoperfd240ab1f7e6\voku\helper\AbstractSimpleHtmlDom implements \IteratorAggregate, \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
{
    /**
    ...
    public function getAllAttributes()
    {
        if ($this->node && $this->node->hasAttributes()) {
            ...
            foreach ($this->node->attributes ?? [] as $attr) {
                $attributes[$attr->name] = \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser::putReplacedBackToPreserveHtmlEntities($attr->value);
            }
            return $attributes;
        }
        return null;
    ...
    public function getAttribute(string $name) : string
    {
        if ($this->node instanceof \DOMElement) {
            return \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser::putReplacedBackToPreserveHtmlEntities($this->node->getAttribute($name));
        }
        return '';
    }
    /**
     ...
     */
    public function removeAttribute(string $name) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
     ...
     * @return SimpleHtmlDomInterface
     */
    protected function replaceChildWithString(string $string) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
        if (!empty($string)) {
            $newDocument = new \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser($string);
     ...
     * @return SimpleHtmlDomInterface
     */
    protected function replaceNodeWithString(string $string) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
        if (empty($string)) {
     ...
     * @return SimpleHtmlDomInterface
     */
    protected function replaceTextWithString($string) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
        if (empty($string)) {
            if ($this->node->parentNode) {
                $this->node->parentNode->removeChild($this->node);
     ...
     * @return SimpleHtmlDomInterface
     */
    public function setAttribute(string $name, $value = null, bool $strict = \false) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
        if ($strict && $value === null || !$strict && empty($value)) {
            /** @noinspection UnusedFunctionResultInspection */
     ...
     * @return SimpleHtmlDomInterface
     */
    public function findOne(string $selector) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
     ...
     * @return SimpleHtmlDomInterface[]|SimpleHtmlDomNodeInterface<SimpleHtmlDomInterface>
     */
    public function getElementByClass(string $class) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomNodeInterface
    {
     ...
     * @return SimpleHtmlDomInterface
     */
    public function getElementById(string $id) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
     ...
     * @return SimpleHtmlDomInterface
     */
    public function getElementByTagName(string $name) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
        if ($this->node instanceof \DOMElement) {
        ...
        if ($node === null) {
            return new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomBlank();
        }
        return new static($node);
    }
    /**
    ...
    public function getElementsByTagName(string $name, $idx = null)
    {
        ...
        $elements = new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomNode();
        ...
        // return one element
        return $elements[$idx] ?? new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomBlank();
    }
    /**
     ...
     */
    public function getHtmlDomParser() : \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser
    {
        return new \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser($this);
    }
    /**
     * @return \DOMNode
     */
     ...
     * @return SimpleHtmlDomInterface
     */
    public function parentNode() : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface
    {
    ...
    public function val($value = null)
    {
        if ($value === null) {
            ...
            if ($this->node->nodeName === 'select') {
                ...
                if ($options instanceof \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomNode) {
     ...
     * @return HtmlDomParser
     */
    protected function cleanHtmlWrapper(\_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser $newDocument, $removeExtraHeadTag = \false) : \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser
    {
     ...
     *                           </p>
     */
    public function getIterator() : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomNodeInterface
    {
        $elements = new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomNode();
    ...
    {
        if ($input instanceof \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser) {
