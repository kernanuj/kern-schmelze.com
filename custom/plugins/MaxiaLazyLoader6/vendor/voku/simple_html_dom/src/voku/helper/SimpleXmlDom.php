 ...
 */
class SimpleXmlDom extends \_PhpScoperfd240ab1f7e6\voku\helper\AbstractSimpleXmlDom implements \IteratorAggregate, \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
{
    /**
    ...
    public function getAllAttributes()
    {
        if ($this->node && $this->node->hasAttributes()) {
            ...
            foreach ($this->node->attributes ?? [] as $attr) {
                $attributes[$attr->name] = \_PhpScoperfd240ab1f7e6\voku\helper\XmlDomParser::putReplacedBackToPreserveHtmlEntities($attr->value);
            }
            return $attributes;
        }
        return null;
    ...
    public function getAttribute(string $name) : string
    {
        if ($this->node instanceof \DOMElement) {
            return \_PhpScoperfd240ab1f7e6\voku\helper\XmlDomParser::putReplacedBackToPreserveHtmlEntities($this->node->getAttribute($name));
        }
        return '';
    }
    /**
     ...
     */
    public function removeAttribute(string $name) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
     ...
     * @return SimpleXmlDomInterface
     */
    protected function replaceChildWithString(string $string) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
        if (!empty($string)) {
            $newDocument = new \_PhpScoperfd240ab1f7e6\voku\helper\XmlDomParser($string);
     ...
     * @return SimpleXmlDomInterface
     */
    protected function replaceNodeWithString(string $string) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
        if (empty($string)) {
     ...
     * @return SimpleXmlDomInterface
     */
    protected function replaceTextWithString($string) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
        if (empty($string)) {
            if ($this->node->parentNode) {
                $this->node->parentNode->removeChild($this->node);
     ...
     * @return SimpleXmlDomInterface
     */
    public function setAttribute(string $name, $value = null, bool $strict = \false) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
     ...
     */
    public function findMulti(string $selector) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomNodeInterface
    {
     ...
     * @return SimpleXmlDomInterface
     */
    public function findOne(string $selector) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
     ...
     * @return SimpleXmlDomInterface[]|SimpleXmlDomNodeInterface<SimpleXmlDomInterface>
     */
    public function getElementByClass(string $class) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomNodeInterface
    {
     ...
     * @return SimpleXmlDomInterface
     */
    public function getElementById(string $id) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
     ...
     * @return SimpleXmlDomInterface
     */
    public function getElementByTagName(string $name) : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
        if ($this->node instanceof \DOMElement) {
        ...
        if ($node === null) {
            return new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomBlank();
        }
        return new static($node);
    }
    /**
    ...
    public function getElementsByTagName(string $name, $idx = null)
    {
        ...
        $elements = new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomNode();
        ...
        if ($idx === null) {
            if (\count($elements) === 0) {
                return new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomNodeBlank();
            }
            return $elements;
        }
        ...
        // return one element
        return $elements[$idx] ?? new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomBlank();
    }
    /**
     * @return \DOMNode
     */
     ...
     * @return XmlDomParser
     */
    public function getXmlDomParser() : \_PhpScoperfd240ab1f7e6\voku\helper\XmlDomParser
    {
        return new \_PhpScoperfd240ab1f7e6\voku\helper\XmlDomParser($this);
    }
    /**
     * Get dom node's inner html.
     *
     ...
     * @return SimpleXmlDomInterface
     */
    public function parentNode() : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomInterface
    {
    ...
    public function val($value = null)
    {
        if ($value === null) {
            ...
            if ($this->node->nodeName === 'select') {
                ...
                if ($options instanceof \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomNode) {
     ...
     *                           </p>
     */
    public function getIterator() : \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomNodeInterface
    {
        $elements = new \_PhpScoperfd240ab1f7e6\voku\helper\SimpleXmlDomNode();
    ...
    {
        if ($input instanceof \_PhpScoperfd240ab1f7e6\voku\helper\XmlDomParser) {
