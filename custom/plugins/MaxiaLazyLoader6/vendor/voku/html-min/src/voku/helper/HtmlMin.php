 ...
 */
class HtmlMin implements \_PhpScoperfd240ab1f7e6\voku\helper\HtmlMinInterface
{
    /**
     * @var string
     */
     ...
     * @psalm-var list<string>
     */
    private static $selfClosingTags = ['area', 'base', 'basefont', 'br', 'col', 'command', 'embed', 'frame', 'hr', 'img', 'input', 'isindex', 'keygen', 'link', 'meta', 'param', 'source', 'track', 'wbr'];
    /**
     * @var string[]
     *
     * @psalm-var array<string, string>
     */
    private static $trimWhitespaceFromTags = ['article' => '', 'br' => '', 'div' => '', 'footer' => '', 'hr' => '', 'nav' => '', 'p' => '', 'script' => ''];
    /**
     * @var array
     */
    private static $booleanAttributes = ['allowfullscreen' => '', 'async' => '', 'autofocus' => '', 'autoplay' => '', 'checked' => '', 'compact' => '', 'controls' => '', 'declare' => '', 'default' => '', 'defaultchecked' => '', 'defaultmuted' => '', 'defaultselected' => '', 'defer' => '', 'disabled' => '', 'enabled' => '', 'formnovalidate' => '', 'hidden' => '', 'indeterminate' => '', 'inert' => '', 'ismap' => '', 'itemscope' => '', 'loop' => '', 'multiple' => '', 'muted' => '', 'nohref' => '', 'noresize' => '', 'noshade' => '', 'novalidate' => '', 'nowrap' => '', 'open' => '', 'pauseonexit' => '', 'readonly' => '', 'required' => '', 'reversed' => '', 'scoped' => '', 'seamless' => '', 'selected' => '', 'sortable' => '', 'truespeed' => '', 'typemustmatch' => '', 'visible' => ''];
    /**
     * @var array
     */
    private static $skipTagsForRemoveWhitespace = ['code', 'pre', 'script', 'style', 'textarea'];
    /**
     * @var array
     */
     ...
     * @var bool
     */
    private $doOptimizeViaHtmlDomParser = \true;
    /**
     * @var bool
     */
    private $doOptimizeAttributes = \true;
    /**
     * @var bool
     */
    private $doRemoveComments = \true;
    /**
     * @var bool
     */
     ...
     * @var bool
     */
    private $doRemoveOmittedQuotes = \true;
    /**
     * @var bool
     */
    private $doRemoveOmittedHtmlTags = \true;
    /**
     * @var bool
     */
     ...
     * @var string[]
     */
    private $domainsToRemoveHttpPrefixFromAttributes = ['google.com', 'google.de'];
    /**
     * @var string[]
     */
     ...
     * @var bool
     */
    private $doSortCssClassNames = \true;
    /**
     * @var bool
     */
    private $doSortHtmlAttributes = \true;
    /**
     * @var bool
     */
    private $doRemoveDeprecatedScriptCharsetAttribute = \true;
    /**
     * @var bool
     */
     ...
     * @var bool
     */
    private $doRemoveDeprecatedAnchorName = \true;
    /**
     * @var bool
     */
    private $doRemoveDeprecatedTypeFromStylesheetLink = \true;
    /**
     * @var bool
     */
    private $doRemoveDeprecatedTypeFromStyleAndLinkTag = \true;
    /**
     * @var bool
     */
    private $doRemoveDefaultMediaTypeFromStyleAndLinkTag = \true;
    /**
     * @var bool
     */
     ...
     * @var bool
     */
    private $doRemoveDeprecatedTypeFromScriptTag = \true;
    /**
     * @var bool
     */
    private $doRemoveValueFromEmptyInput = \true;
    /**
     * @var bool
     */
    private $doRemoveEmptyAttributes = \true;
    /**
     * @var bool
     */
    private $doSumUpWhitespace = \true;
    /**
     * @var bool
     */
    ...
    public function __construct()
    {
        ...
        $this->attachObserverToTheDomLoop(new \_PhpScoperfd240ab1f7e6\voku\helper\HtmlMinDomObserverOptimizeAttributes());
    }
    /**
     ...
     * @return void
     */
    public function attachObserverToTheDomLoop(\_PhpScoperfd240ab1f7e6\voku\helper\HtmlMinDomObserverInterface $observer)
    {
     ...
     * @return $this
     */
    public function doOptimizeAttributes(bool $doOptimizeAttributes = \true) : self
    {
     ...
     * @return $this
     */
    public function doOptimizeViaHtmlDomParser(bool $doOptimizeViaHtmlDomParser = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveComments(bool $doRemoveComments = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveDefaultAttributes(bool $doRemoveDefaultAttributes = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveDeprecatedAnchorName(bool $doRemoveDeprecatedAnchorName = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveDeprecatedScriptCharsetAttribute(bool $doRemoveDeprecatedScriptCharsetAttribute = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveDeprecatedTypeFromScriptTag(bool $doRemoveDeprecatedTypeFromScriptTag = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveDeprecatedTypeFromStylesheetLink(bool $doRemoveDeprecatedTypeFromStylesheetLink = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveDeprecatedTypeFromStyleAndLinkTag(bool $doRemoveDeprecatedTypeFromStyleAndLinkTag = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveDefaultMediaTypeFromStyleAndLinkTag(bool $doRemoveDefaultMediaTypeFromStyleAndLinkTag = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveDefaultTypeFromButton(bool $doRemoveDefaultTypeFromButton = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveEmptyAttributes(bool $doRemoveEmptyAttributes = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveHttpPrefixFromAttributes(bool $doRemoveHttpPrefixFromAttributes = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveHttpsPrefixFromAttributes(bool $doRemoveHttpsPrefixFromAttributes = \true) : self
    {
     ...
     * @return $this
     */
    public function doKeepHttpAndHttpsPrefixOnExternalAttributes(bool $doKeepHttpAndHttpsPrefixOnExternalAttributes = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveOmittedHtmlTags(bool $doRemoveOmittedHtmlTags = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveOmittedQuotes(bool $doRemoveOmittedQuotes = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveSpacesBetweenTags(bool $doRemoveSpacesBetweenTags = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveValueFromEmptyInput(bool $doRemoveValueFromEmptyInput = \true) : self
    {
     ...
     * @return $this
     */
    public function doRemoveWhitespaceAroundTags(bool $doRemoveWhitespaceAroundTags = \true) : self
    {
     ...
     * @return $this
     */
    public function doSortCssClassNames(bool $doSortCssClassNames = \true) : self
    {
     ...
     * @return $this
     */
    public function doSortHtmlAttributes(bool $doSortHtmlAttributes = \true) : self
    {
     ...
     * @return $this
     */
    public function doSumUpWhitespace(bool $doSumUpWhitespace = \true) : self
    {
    ...
    private function domNodeAttributesToString(\DOMNode $node) : string
    {
        ...
        if ($node->attributes !== null) {
            foreach ($node->attributes as $attribute) {
                ...
                if ($this->doOptimizeAttributes && isset(self::$booleanAttributes[$attribute->name])) {
                    $attr_str .= ' ';
                    continue;
                }
                $attr_str .= '=';
                // http://www.whatwg.org/specs/web-apps/current-work/multipage/syntax.html#attributes-0
                $omit_quotes = $this->doRemoveOmittedQuotes && $attribute->value !== '' && \strpos($attribute->name, '____SIMPLE_HTML_DOM__VOKU') !== 0 && \strpos($attribute->name, ' ') === \false && \preg_match('/["\'=<>` \\t\\r\\n\\f]/', $attribute->value) === 0;
                $quoteTmp = '"';
                if (!$omit_quotes && \strpos($attribute->value, '"') !== \false) {
                    $quoteTmp = "'";
                }
                if ($this->doOptimizeAttributes && ($attribute->name === 'srcset' || $attribute->name === 'sizes')) {
    ...
    private function domNodeClosingTagOptional(\DOMNode $node) : bool
    {
        ...
        return \in_array($tag_name, self::$optional_end_tags, \true) || $tag_name === 'li' && ($nextSibling === null || $nextSibling instanceof \DOMElement && $nextSibling->tagName === 'li') || $tag_name === 'optgroup' && ($nextSibling === null || $nextSibling instanceof \DOMElement && $nextSibling->tagName === 'optgroup') || $tag_name === 'rp' && ($nextSibling === null || $nextSibling instanceof \DOMElement && ($nextSibling->tagName === 'rp' || $nextSibling->tagName === 'rt')) || $tag_name === 'tr' && ($nextSibling === null || $nextSibling instanceof \DOMElement && $nextSibling->tagName === 'tr') || $tag_name === 'source' && ($parent_tag_name === 'audio' || $parent_tag_name === 'video' || $parent_tag_name === 'picture' || $parent_tag_name === 'source') && ($nextSibling === null || $nextSibling instanceof \DOMElement && $nextSibling->tagName === 'source') || ($tag_name === 'td' || $tag_name === 'th') && ($nextSibling === null || $nextSibling instanceof \DOMElement && ($nextSibling->tagName === 'td' || $nextSibling->tagName === 'th')) || ($tag_name === 'dd' || $tag_name === 'dt') && ($nextSibling === null || $nextSibling instanceof \DOMElement && ($nextSibling->tagName === 'dd' || $nextSibling->tagName === 'dt')) || $tag_name === 'option' && ($nextSibling === null || $nextSibling instanceof \DOMElement && ($nextSibling->tagName === 'option' || $nextSibling->tagName === 'optgroup')) || $tag_name === 'p' && ($nextSibling === null && $node->parentNode !== null && !\in_array($node->parentNode->nodeName, ['a', 'audio', 'del', 'ins', 'map', 'noscript', 'video'], \true) || $nextSibling instanceof \DOMElement && \in_array($nextSibling->tagName, ['address', 'article', 'aside', 'blockquote', 'dir', 'div', 'dl', 'fieldset', 'footer', 'form', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'header', 'hgroup', 'hr', 'menu', 'nav', 'ol', 'p', 'pre', 'section', 'table', 'ul'], \true));
    }
    protected function domNodeToString(\DOMNode $node) : string
    {
        ...
        foreach ($node->childNodes as $child) {
            ...
            if ($child instanceof \DOMElement) {
                ...
                if (!($this->doRemoveOmittedHtmlTags && !$this->isHTML4 && !$this->isXHTML && $this->domNodeClosingTagOptional($child))) {
                    $html .= '</' . $child->tagName . '>';
                }
                if (!$this->doRemoveWhitespaceAroundTags) {
                    ...
                    if ($nextSiblingTmp instanceof \DOMText && $nextSiblingTmp->wholeText === ' ') {
                        if ($emptyStringTmp !== 'last_was_empty' && \substr($html, -1) !== ' ') {
                            $html = \rtrim($html);
                            if ($child->parentNode && $child->parentNode->nodeName !== 'head') {
                                $html .= ' ';
                            }
                        }
                ...
                if ($child->isElementContentWhitespace()) {
                    if ($child->previousSibling !== null && $child->nextSibling !== null) {
                        if ($child->wholeText && \strpos($child->wholeText, ' ') !== \false || $emptyStringTmp !== 'last_was_empty' && \substr($html, -1) !== ' ') {
                            $html = \rtrim($html);
                            if ($child->parentNode && $child->parentNode->nodeName !== 'head') {
                                $html .= ' ';
                            }
    ...
    private function getDoctype(\DOMNode $node) : string
    {
        ...
        foreach ($node->childNodes as $child) {
            if ($child instanceof \DOMDocumentType && $child->name) {
                ...
                return '<!DOCTYPE ' . $child->name . '' . ($child->publicId ? ' ' . $tmpTypePublic . ' "' . $child->publicId . '"' : '') . ($child->systemId ? ' ' . $tmpTypeSystem . ' "' . $child->systemId . '"' : '') . '>';
            }
        }
        return '';
    }
    ...
    public function minify($html, $multiDecodeNewHtmlEntity = \false) : string
    {
        ...
        if (\strpos($html, ' ') !== \false) {
            $html = (string) \preg_replace_callback('#<([^/\\s<>!]+)(?:\\s+([^<>]*?)\\s*|\\s*)(/?)>#', static function ($matches) {
        ...
        if (\strpos($html, $this->protectedChildNodesHelper) !== \false) {
            $html = (string) \preg_replace_callback('/<(?<element>' . $this->protectedChildNodesHelper . ')(?<attributes> [^>]*)?>(?<value>.*?)<\\/' . $this->protectedChildNodesHelper . '>/', [$this, 'restoreProtectedHtml'], $html);
        }
        // -------------------------------------------------------------------------
        // Restore protected HTML-entities.
        // -------------------------------------------------------------------------
        if ($this->doOptimizeViaHtmlDomParser) {
            $html = \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser::putReplacedBackToPreserveHtmlEntities($html);
        }
        // ------------------------------------
        // Final clean-up
        // ------------------------------------
        $html = \str_replace(['html>' . "\n", "\n" . '<html', 'html/>' . "\n", "\n" . '</html', 'head>' . "\n", "\n" . '<head', 'head/>' . "\n", "\n" . '</head'], ['html>', '<html', 'html/>', '</html', 'head>', '<head', 'head/>', '</head'], $html);
    ...
    protected function getNextSiblingOfTypeDOMElement(\DOMNode $node)
    {
        do {
            ...
            if ($nodeTmp instanceof \DOMText) {
                if (\trim($nodeTmp->textContent) !== '' && \strpos($nodeTmp->textContent, '<') === \false) {
                    $node = $nodeTmp;
                } else {
    ...
    {
        // init dom
        $dom = new \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser();
        ...
        // do not formats output with indentation
        ...
        // -------------------------------------------------------------------------
        return $dom->fixHtmlOutput($doctypeStr . $this->domNodeToString($dom->getDocument()), $multiDecodeNewHtmlEntity);
    }
    /**
     ...
     * @return void
     */
    private function notifyObserversAboutDomElementAfterMinification(\_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface $domElement)
    {
     ...
     * @return void
     */
    private function notifyObserversAboutDomElementBeforeMinification(\_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface $domElement)
    {
        foreach ($this->domLoopObservers as $observer) {
     ...
     */
    private function protectTagHelper(\_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser $dom, string $selector) : \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser
    {
     ...
     * @return HtmlDomParser
     */
    private function protectTags(\_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser $dom) : \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser
    {
        ...
        foreach ($dom->find('//comment()') as $element) {
            ...
            $text = $element->text();
            if (!$this->isConditionalComment($text) && !$this->isSpecialComment($text)) {
                continue;
            }
     ...
     * @return HtmlDomParser
     */
    private function removeComments(\_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser $dom) : \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser
    {
     ...
     * @return void
     */
    private function removeWhitespaceAroundTags(\_PhpScoperfd240ab1f7e6\voku\helper\SimpleHtmlDomInterface $element)
    {
     ...
     * @return HtmlDomParser
     */
    private function sumUpWhitespace(\_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser $dom) : \_PhpScoperfd240ab1f7e6\voku\helper\HtmlDomParser
    {
