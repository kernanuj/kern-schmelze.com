...
use _PhpScoper833c86d6963f\Masterminds\HTML5\Parser\EventHandler;
/**
 ...
 */
class EventStack implements \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\EventHandler
{
    protected $stack;
    ...
    {
        $this->stack[] = array('name' => $event, 'data' => $data);
    }
    ...
    public function startTag($name, $attributes = array(), $selfClosing = \false)
    {
        ...
        if ('pre' == $name || 'script' == $name) {
            return \_PhpScoper833c86d6963f\Masterminds\HTML5\Elements::TEXT_RAW;
        }
    }
