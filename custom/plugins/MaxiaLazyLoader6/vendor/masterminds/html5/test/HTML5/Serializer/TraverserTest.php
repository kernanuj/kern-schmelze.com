...
class TraverserTest extends \_PhpScoper833c86d6963f\Masterminds\HTML5\Tests\TestCase
{
    ...
    public function getTraverser()
    {
        ...
        $t = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Serializer\Traverser($dom, $stream, $html5->getOptions());
    ...
    public function testConstruct()
    {
        ...
        $dom = $this->html5->loadHTML($this->markup);
        $t = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Serializer\Traverser($dom, $stream, $r, $html5->getOptions());
        $this->assertInstanceOf('_PhpScoper833c86d6963f\\Masterminds\\HTML5\\Serializer\\Traverser', $t);
    }
    public function testFragmentDeprecated()
    {
        $html = '<span class="bar">foo</span><span></span><div>bar</div>';
        $input = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\StringInputStream($html);
