...
use _PhpScoper833c86d6963f\Masterminds\HTML5\Parser\TreeBuildingRules;
 ...
 */
class TreeBuildingRulesTest extends \_PhpScoper833c86d6963f\Masterminds\HTML5\Tests\TestCase
{
    ...
    {
        $events = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\DOMTreeBuilder(\true);
        $scanner = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner($string);
        $parser = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Tokenizer($scanner, $events);
        $parser->parse();
    ...
    public function testHasRules()
    {
        ...
        $engine = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\TreeBuildingRules($doc);
