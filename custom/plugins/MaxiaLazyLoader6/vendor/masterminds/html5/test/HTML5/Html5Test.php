...
class Html5Test extends \_PhpScoper833c86d6963f\Masterminds\HTML5\Tests\TestCase
{
    /**
     * @var HTML5
     */
    ...
    {
        // doc
        $dom = $this->html5->loadHTML($this->wrap('<t:tag/>'), array('implicitNamespaces' => array('t' => 'http://example.com'), 'xmlNamespaces' => \true));
        ...
        // doc fragment
        $frag = $this->html5->loadHTMLFragment('<t:tag/>', array('implicitNamespaces' => array('t' => 'http://example.com'), 'xmlNamespaces' => \true));
    ...
    {
        $dom = $this->html5->load(__DIR__ . '/Fixtures/encoding/windows-1252.html', array('encoding' => 'Windows-1252'));
        $this->assertInstanceOf('\\DOMDocument', $dom);
        $this->assertEmpty($this->html5->getErrors());
        $this->assertFalse($this->html5->hasErrors());
...
';
    ...
    public function testSave()
    {
        ...
        // Test file
        $tmpfname = \tempnam(\sys_get_temp_dir(), 'html5-php');
    ...
    public function testConfig()
    {
        ...
        $html5 = $this->getInstance(array('foo' => 'bar', 'encode_entities' => \true));
        $options = $html5->getOptions();
        $this->assertEquals('bar', $options['foo']);
        $this->assertEquals(\true, $options['encode_entities']);
    ...
    {
        $dom = $this->html5->loadHTML('<html><body><Button color="red">Error</Button></body></html>', array('xmlNamespaces' => \true));
        $out = $this->html5->saveHTML($dom);
