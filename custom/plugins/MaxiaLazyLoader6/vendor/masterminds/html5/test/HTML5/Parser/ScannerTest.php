...
use _PhpScoper833c86d6963f\Masterminds\HTML5\Parser\StringInputStream;
use _PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner;
class ScannerTest extends \_PhpScoper833c86d6963f\Masterminds\HTML5\Tests\TestCase
{
    /**
    ...
    {
        $is = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\StringInputStream('abc');
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner($is);
        $this->assertInstanceOf('_PhpScoper833c86d6963f\\Masterminds\\HTML5\\Parser\\Scanner', $s);
    }
    public function testConstruct()
    {
        $this->assertInstanceOf('_PhpScoper833c86d6963f\\Masterminds\\HTML5\\Parser\\Scanner', new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner('abc'));
    }
    public function testNextDeprecated()
    {
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner(new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\StringInputStream('abc'));
        $this->assertEquals('b', $s->next());
        $this->assertEquals('c', $s->next());
    }
    public function testNext()
    {
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner('abc');
        $this->assertEquals('b', $s->next());
        $this->assertEquals('c', $s->next());
    }
    ...
    {
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner('abcdefghijklmnopqrst');
    ...
    {
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner('ab13ck45DE*');
    ...
    {
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner('abcdef1%mnop*');
    ...
    {
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner('abcdef1ghpo#mn94op');
    ...
    {
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner('1784a 45 9867 #');
    ...
    {
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner("1784a\n45\n9867 #\nThis is a test.");
    ...
    {
        $s = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Parser\Scanner("1784a a\n45 9867 #\nThis is a test.");
