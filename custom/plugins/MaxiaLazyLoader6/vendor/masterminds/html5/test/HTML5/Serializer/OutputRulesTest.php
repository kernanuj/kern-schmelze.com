...
namespace _PhpScoper833c86d6963f\Masterminds\HTML5\Tests\Serializer;
...
class OutputRulesTest extends \_PhpScoper833c86d6963f\Masterminds\HTML5\Tests\TestCase
{
    ...
    {
        $class = new \ReflectionClass('_PhpScoper833c86d6963f\\Masterminds\\HTML5\\Serializer\\OutputRules');
    ...
    {
        $class = new \ReflectionClass('_PhpScoper833c86d6963f\\Masterminds\\HTML5\\Serializer\\Traverser');
    ...
    public function getOutputRules($options = array())
    {
        ...
        $r = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Serializer\OutputRules($stream, $options);
        $t = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Serializer\Traverser($dom, $stream, $r, $options);
    ...
    public function testDocument()
    {
        ...
        $stream = \fopen('php://temp', 'w');
        $r = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Serializer\OutputRules($stream, $this->html5->getOptions());
        $t = new \_PhpScoper833c86d6963f\Masterminds\HTML5\Serializer\Traverser($dom, $stream, $r, $this->html5->getOptions());
        $r->document($dom);
    ...
    {
        $this->html5 = $this->getInstance(array('xmlNamespaces' => \true));
        $source = '
            <!DOCTYPE html>
        ...
        $dom = $this->html5->loadHTML($source, array('xmlNamespaces' => \true));
    ...
    {
        return array(array(\false, '&\'<>"', '&amp;\'&lt;&gt;"', '&amp;&apos;&lt;&gt;&quot;'), array(\false, 'This + is. a < test', 'This + is. a &lt; test', 'This &plus; is&period; a &lt; test'), array(\false, '.+#', '.+#', '&period;&plus;&num;'), array(\true, '.+#\'', '.+#\'', '&period;&plus;&num;&apos;'), array(\true, '&".<', '&amp;&quot;.<', '&amp;&quot;&period;&lt;'), array(\true, '&\'<>"', '&amp;\'<>&quot;', '&amp;&apos;&lt;&gt;&quot;'), array(\true, " \"'", '&nbsp;&quot;\'', '&nbsp;&quot;&apos;'));
    }
    /**
    ...
    public function testEnc($isAttribute, $test, $expected, $expectedEncoded)
    {
        ...
        list($o, $s) = $this->getOutputRules(array('encode_entities' => \true));
        $m = $this->getProtectedMethod('enc');
    ...
    {
        return array(array('<img alt="" ismap>'), array('<img alt="">'), array('<input type="radio" readonly>'), array('<input type="radio" checked disabled>'), array('<input type="checkbox" checked disabled>'), array('<input type="radio" value="" checked disabled>'), array('<div data-value=""></div>'), array('<select disabled></select>'), array('<div ng-app></div>'), array('<script defer></script>'));
    }
    /**
