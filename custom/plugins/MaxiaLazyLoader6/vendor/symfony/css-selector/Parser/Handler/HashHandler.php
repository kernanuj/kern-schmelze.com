 ...
 * @internal
 */
class HashHandler implements \_PhpScoper833c86d6963f\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
{
    private $patterns;
    private $escaping;
    ...
    public function handle(\_PhpScoper833c86d6963f\Symfony\Component\CssSelector\Parser\Reader $reader, \_PhpScoper833c86d6963f\Symfony\Component\CssSelector\Parser\TokenStream $stream) : bool
    {
        ...
        $stream->push(new \_PhpScoper833c86d6963f\Symfony\Component\CssSelector\Parser\Token(\_PhpScoper833c86d6963f\Symfony\Component\CssSelector\Parser\Token::TYPE_HASH, $value, $reader->getPosition()));
