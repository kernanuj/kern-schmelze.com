        ...
        modalRequest: {
            ...
            handler() {
                ...
                if (this.modalRequest.captured_amount) {
                    this.orderAmount.push({ type: 'captured', value: this.modalRequest.captured_amount });
                }
                if (this.modalRequest.refunded_amount) {
                    this.orderAmount.push({ type: 'refunded', value: this.modalRequest.refunded_amount });
                }
            }
        },
