...
class KlarnaInstaller implements InstallerInterface
{
    ...
    public function activate(ActivateContext $context): void
    {
        ...
        $this->getRuleInstaller()->activate($context);
    }
    ...
    public function deactivate(DeactivateContext $context): void
    {
        ...
        $this->getRuleInstaller()->deactivate($context);
    }
    ...
    private function getPaymentMethodInstaller(): InstallerInterface
    {
        ...
        return new PaymentMethodInstaller($paymentMethodRepository, $pluginIdProvider, $languageProvider);
    }
    ...
    private function getRuleInstaller(): InstallerInterface
    {
        ...
        return new RuleInstaller($ruleRepository, $countryRepository);
    }
