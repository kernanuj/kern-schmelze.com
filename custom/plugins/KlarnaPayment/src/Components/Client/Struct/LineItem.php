...
class LineItem extends Struct
{
    ...
    public function jsonSerialize(): array
    {
        return [
            ...
            'unit_price'          => (int) round($this->getUnitPrice() * (10 ** $this->getPrecision()), 0),
            'tax_rate'            => (int) round($this->getTaxRate() * 100, 0),
            'total_amount'        => (int) round($this->getTotalAmount() * (10 ** $this->getPrecision()), 0),
            'total_tax_amount'    => (int) round($this->getTotalTaxAmount() * (10 ** $this->getPrecision()), 0),
