...
class WizardController extends AbstractController
{
    ...
    /**
     * @Route("/api/v{version}/_action/klarna_payment/finalize_installation", name="api.action.klarna_payment.finalize.installation", methods={"POST"})
     */
    ...
    /**
     * @Route("/api/v{version}/_action/klarna_payment/fetch_data", name="api.action.klarna_payment.fetch.data", methods={"GET"})
     */
