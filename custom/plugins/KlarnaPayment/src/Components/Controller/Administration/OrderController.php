...
class OrderController extends AbstractController
{
    ...
    /**
     * @Route("/api/v{version}/_action/klarna_payment/fetch_order", name="api.action.klarna_payment.order.fetch", methods={"POST"})
     */
    ...
    /**
     * @Route("/api/v{version}/_action/klarna_payment/capture_order", name="api.action.klarna_payment.order.capture", methods={"POST"})
     */
    ...
    /**
     * @Route("/api/v{version}/_action/klarna_payment/refund_order", name="api.action.klarna_payment.order.refund", methods={"POST"})
     */
    ...
    /**
     * @Route("/api/v{version}/_action/klarna_payment/extend_authorization", name="api.action.klarna_payment.extend.authorization", methods={"POST"})
     */
    ...
    /**
     * @Route("/api/v{version}/_action/klarna_payment/cancel_payment", name="api.action.klarna_payment.cancel.payment", methods={"POST"})
     */
    ...
    /**
     * @Route("/api/v{version}/_action/klarna_payment/release_remaining_authorization", name="api.action.klarna_payment.release.remaining.authorization", methods={"POST"})
     */
