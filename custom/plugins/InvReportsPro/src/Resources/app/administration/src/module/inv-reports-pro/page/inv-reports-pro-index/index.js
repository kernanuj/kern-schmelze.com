import template from './inv-reports-pro-index.html.twig';
import './inv-reports-pro-index.scss';

const { Component } = Shopware;
const { Criteria } = Shopware.Data;

Component.register('inv-reports-pro-index', {
    template,
    ...
    computed: {
        chartOptionsOrderCount() {
            return {
                title: { text: this.$tc('inv-reports-pro.monthStats.orderNumber') },
        ...
        chartOptionsOrderSum() {
            return {
                title: { text: this.$tc('inv-reports-pro.monthStats.turnover') },
        ...
        orderCountMonthSeries() {
            ...
            return [{ name: this.$tc('inv-reports-pro.monthStats.numberOfOrders'), data: seriesData }];
        },
    ...
    methods: {
        ...
        orderGridColumns() {
            return [{
                ...
                label: 'inv-reports-pro.todayStats.orderTime',
                allowResize: true,
                primary: false
            }, {
